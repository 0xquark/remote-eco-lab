...
getwd()
# Inputs:
idleMarkersFilename <- "log_idle.csv" # -> scenarioMarkersFilename
PowerIdleFilename <- "pm_idl.csv" # -> PowerScenarioFilename
performanceIdleFilename <- "hw_idl.csv" # -> performanceScenarioFilename
...
outputFileName <- "~/Report_Idle.pdf"
graphicsFolder <- "graphics_idle"
