...
for ((i = 0 ; i < 1 ; i++)); do
    ...
    cp ./test_data/20yearsofKDE.pdf ~/20yearsofKDE.pdf
    ...
    timestamp "$i" "Mark text and insert command"
    ...
    timestamp "$i" "Start presentation mode and move up and down pages"
    # Toggle presentation
    ...
    timestamp "$i" "Move forward and backward 5 pages"
    xdotool key Right
    syncUp 2
    xdotool key Right
    syncUp 2
...
# Note: now goes to page number 42, writes slightly different annotation
    ...
    # Mark text and insert comment
    echo " Toggle annotation panel "
    timestamp "$i" "Mark text and insert comment"
    # Toggle annotations panel
    xdotool key F6
    syncUp 2
    # Move mouse to center of Okular window
    ...
    # Start presentation mode and move up and down pages
    echo " Start presentation mode "
    timestamp "$i" "Start presentation mode and exit the mode"
    # Toggle presentation
    xdotool key Ctrl+Shift+p
    syncUp 2
    # Close default popup window
    ...
    # Zoom out
    echo " Zoom to 100% "
    timestamp "$i" "Zoom to 100% and 400%"
    xdotool key Ctrl+0
    syncUp 3
    echo " Zoom to 400% "
    # Zoom in
